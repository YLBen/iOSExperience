...
-(instancetype)initWithFrame:(CGRect)frame{
    if ([super initWithFrame:frame]) {
        ...
        _lblHobby.textColor=[UIColor colorWithHexString:@"1f1f1f"];
        _lblHobby.font=[UIFont systemFontOfSize:12.0f];
        ...
        _imgHead.backgroundColor=[UIColor colorWithHexString:@"f2f2f2"];
        ...
        _lblNickName.textColor=[UIColor blackColor];
        _lblNickName.font=[UIFont systemFontOfSize:12.0f];
        [self addSubview:_lblNickName];
        
        _lblAge=[[UILabel alloc]initWithFrame:CGRectMake(_lblNickName.left, 0, _lblNickName.width, 15)];
        _lblAge.textColor=[UIColor colorWithHexString:@"1f1f1f"];
        _lblAge.font=[UIFont systemFontOfSize:12.0f];
        [self addSubview:_lblAge];
        
        _line2=[[UIView alloc]initWithFrame:CGRectMake(0, _imgHead.bottom+10, frame.size.width, 0.5)];
        _line2.backgroundColor=[UIColor colorWithHexString:@"ededed"];
        [self addSubview:_line2];
        
        _lblFrom=[[UILabel alloc]initWithFrame:CGRectMake(10, 0, frame.size.width-80, 15)];
        _lblFrom.textColor=[UIColor colorWithHexString:@"5c5c5c"];
        _lblFrom.font=[UIFont systemFontOfSize:12.0f];
        ...
        _juli.textColor=[UIColor colorWithHexString:@"5c5c5c"];
        _juli.font=[UIFont systemFontOfSize:12.0f];
...
//    _imgView.backgroundColor=[UIColor colorWithHexString:personModel.imageAve];
    _imgView.backgroundColor= [UIColor whiteColor];
    [_imgView sd_setImageWithURL:[NSURL URLWithString:personModel.picture] placeholderImage:[UIImage imageWithColor:[UIColor grayColor]]];
    _lblHobby.text=personModel.hobbys;
    [_imgHead sd_setImageWithURL:[NSURL URLWithString:personModel.headImg] placeholderImage:[UIImage imageWithColor:[UIColor grayColor]]];
