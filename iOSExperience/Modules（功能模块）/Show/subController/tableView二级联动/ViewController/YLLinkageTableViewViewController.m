//
//  YLLinkageTableViewViewController.m
//  iOSExperience
//
//  Created by Ben Lv on 2018/8/11.
//  Copyright © 2018年 avatar. All rights reserved.
//

#import "YLLinkageTableViewViewController.h"

@interface YLLinkageTableViewViewController ()<UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate>
...
@implementation YLLinkageTableViewViewController

#pragma mark - life cycle
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"tableView二级联动";
...
- (UITableView *)leftTableView{
    ...
    if (_leftTableView == nil) {
        _leftTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH / 3.0, SCREEN_HEIGHT) style:UITableViewStyleGrouped];
...
- (UITableView *)rightTableView{
    ...
    if (_rightTableView == nil) {
        _rightTableView = [[UITableView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH / 3.0, 0, SCREEN_WIDTH / 3.0 * 2, SCREEN_HEIGHT) style:UITableViewStylePlain];
